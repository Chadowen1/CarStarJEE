  ...
  <div class="header-main">
    ...
    <div class="container">
      ...
      <div class="header-user-actions">
        ...
        <button class="action-btn" onclick="openPopup()">
        ...
        <button type="button" class="action-btn" onclick="location.href='logout'">
        ...
        <li class="menu-category">
          ...
          <div class="dropdown-panel">
            ...
            <ul class="dropdown-panel-list">
              ...
              <li class="panel-list-item">
                <a href="#">
                  <img src="./assets/images/mx8egega.png" alt="headphone collection" width="250"
                       height="119">
                </a>
              </li>
...
<script>
  function openPopup() {
    // Open new window with the specified properties
    window.open("popup.jsp", "MyPopup", "width=400,height=300,left=200,top=200");
  }
</script>
</body>
